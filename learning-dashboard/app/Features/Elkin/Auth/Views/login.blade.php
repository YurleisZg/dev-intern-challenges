<x-layoutDasboard>
  <div class="flex items-center justify-center mt-8">
    <div class="max-w-md bg-white border rounded-2xl p-6 shadow">
      ...
      <form class="mt-6 space-y-4" method="POST" action="{{ route('elkin.challenges.auth.login.store') }}">
        @csrf
      ...
      <p class="text-sm text-gray-600 mt-4">
        ...
        <a class="underline" href="{{ route('elkin.challenges.auth.register') }}">Sign Up</a>
      </p>
    </div>
  </div>
</x-layoutDasboard>
