    ...
    public function save(SalaryRecord $record): int
    {
        ...
        if ($record->getId() === null) {
            ...
            $sql = "UPDATE " . self::TABLE . " SET 
                base_salary = :baseSalary, tax = :tax, health_insurance = :healthInsurance, 
                bonus = :bonus, final_base_net = :finalBaseNet, total_overtime_payment = :totalOtPayment, 
                grand_total_salary = :grandTotalSalary, input_rows = :rows, 
                input_dates = :dates, input_start_times = :starts, input_end_times = :ends, 
